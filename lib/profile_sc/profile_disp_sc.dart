...
class _ProfileDispScViewState extends State<ProfileDispScView> {
        ...
        child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _getRow(title: "Mobile Number", value: "(603) 555-0123",width: scWidth),
                _getRow(title: "Address", value: "2118 Thornridge Cir. Syracuse, Connecticut",width: scWidth),
                _getRow(title: "Reg Device Id", value: "0212025689",width: scWidth),
                Row(
  ...
  Widget _getRow(
      ...
      required String value,required double width}) {
    return Container(
      width: width,

...
class IconAssets{
  ...
  static const String home_active_ic = "${ICON_PATH}/home_active_ic.svg";
  static const String new_group_ic = "${ICON_PATH}/new_group.svg";
  static const String offline_records_ic = "${ICON_PATH}/offline_records.svg";
  static const String otp_ic = "${ICON_PATH}/otp.svg";
  static const String reports_ic = "${ICON_PATH}/reports.svg";
  static const String settings_ic = "${ICON_PATH}/settings.svg";
  static const String settings_active_ic = "${ICON_PATH}/settings_active.svg";
  static const String sms_ic = "${ICON_PATH}/chat.png";
  static const String whatsapp_ic = "${ICON_PATH}/whatsapp.svg";
  static const String menu_ic = "${ICON_PATH}/menu.svg";
  static const String logout_ic = "${ICON_PATH}/logout.svg";
  static const String kyc_ic = "${ICON_PATH}/kyc.svg";
